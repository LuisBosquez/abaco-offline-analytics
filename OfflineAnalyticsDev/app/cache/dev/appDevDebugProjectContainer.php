...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig'), $this->get('monolog.logger.assetic', ContainerInterface::NULL_ON_INVALID_REFERENCE)), new \Assetic\Cache\ConfigCache('/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/Library/WebServer/Documents/OfflineAnalyticsDev/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        return $this->services['besimple.soap.cache'] = new \BeSimple\SoapBundle\Cache(true, 1, '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/besimple/soap/cache', NULL, NULL);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Library/WebServer/Documents/OfflineAnalyticsDev/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'us-cdbr-azure-west-b.cleardb.com', 'port' => NULL, 'dbname' => 'AbacoOfflineAnalyticsAdmin', 'user' => 'b250dd54974739', 'password' => 'd8db4c2c', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_a2e7c4e09fc8e90c73b7535592ed2ef217c31092e115e5f4707587854a87a37e');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_a2e7c4e09fc8e90c73b7535592ed2ef217c31092e115e5f4707587854a87a37e');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a2e7c4e09fc8e90c73b7535592ed2ef217c31092e115e5f4707587854a87a37e');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Library/WebServer/Documents/OfflineAnalyticsDev/src/OfflineAnalytics/CoreBundle/Entity')), 'OfflineAnalytics\\CoreBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('OfflineAnalyticsCoreBundle' => 'OfflineAnalytics\\CoreBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Library/WebServer/Documents/OfflineAnalyticsDev/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Library/WebServer/Documents/OfflineAnalyticsDev/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Library/WebServer/Documents/OfflineAnalyticsDev/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Library/WebServer/Documents/OfflineAnalyticsDev/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Library/WebServer/Documents/OfflineAnalyticsDev/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/src/OfflineAnalytics/OfflineAnalyticsBundle/Resources/views', 'OfflineAnalyticsOfflineAnalytics');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/noiselabs/nusoap-bundle/NoiseLabs/Bundle/NuSOAPBundle/Resources/views', 'NoiseLabsNuSOAP');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/src/OfflineAnalytics/AdminBundle/Resources/views', 'OfflineAnalyticsAdmin');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/src/OfflineAnalytics/CoreBundle/Resources/views', 'OfflineAnalyticsCore');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/app/Resources/views');
        $instance->addPath('/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Library/WebServer/Documents/OfflineAnalyticsDev/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Library/WebServer/Documents/OfflineAnalyticsDev/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev',
            'kernel.logs_dir' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/logs',
            'kernel.bundles' => array(
                ...
                'OfflineAnalyticsOfflineAnalyticsBundle' => 'OfflineAnalytics\\OfflineAnalyticsBundle\\OfflineAnalyticsOfflineAnalyticsBundle',
                ...
                'OfflineAnalyticsAdminBundle' => 'OfflineAnalytics\\AdminBundle\\OfflineAnalyticsAdminBundle',
                'OfflineAnalyticsCoreBundle' => 'OfflineAnalytics\\CoreBundle\\OfflineAnalyticsCoreBundle',
            ...
            'database_host' => 'us-cdbr-azure-west-b.cleardb.com',
            'database_port' => NULL,
            'database_name' => 'AbacoOfflineAnalyticsAdmin',
            'database_user' => 'b250dd54974739',
            'database_password' => 'd8db4c2c',
            ...
            'debug.container.dump' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/profiler',
            ...
            'router.resource' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/../web',
            'assetic.write_to' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/doctrine/orm/Proxies',
            ...
            'besimple.soap.cache.dir' => '/Library/WebServer/Documents/OfflineAnalyticsDev/app/cache/dev/besimple/soap',
